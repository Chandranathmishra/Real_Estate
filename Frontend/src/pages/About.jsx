  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      ...
      <p className="mb-4 text-slate-700">
        Mishra Estate is a leading real estate agency that specializes in
      ...
      <div className="text-center">
        <span className="px-4 py-2 rounded-lg  inline-block bg-slate-200 ">
          This App is created by Chandra Nath Mishra
        </span>
      </div>
    </div>
  );
